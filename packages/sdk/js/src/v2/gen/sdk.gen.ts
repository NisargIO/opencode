...
import type {
  ...
  SessionResumeAsyncErrors,
  SessionResumeAsyncResponses,
  SessionRevertErrors,
...
export class Session2 extends HeyApiClient {
  ...
  /**
   * Resume an existing turn
   *
   * Continue the existing session asynchronously without creating or updating a user message.
   */
  public resumeAsync<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
      workspace?: string
    ...
    return (options?.client ?? this.client).post<SessionResumeAsyncResponses, SessionResumeAsyncErrors, ThrowOnError>({
